...
function checkAchieve() {
  ...
  get("nextRowAchieve").textContent = 
    ...
    "Perform 8 Factor Shifts to unlock the next row of achievements",
    "Unlock Challenges to unlock the next row of achievements",
    "Extend Incrementy to unlock the next row of achievements",
    "Unlock the next layer to unlock the next two rows of achievements",
    "How do you have exactly 6 rows of achievements unlocked? This is impossible!",
    "Get all of the sluggish milestones to unlock the next row of achievements",
    "Unlock Omega Challenges to unlock the next row of achievements",
    "Enter the Portal and have 90 achievements to unlock the next row of achievements",
    "Unlock Base 2 (coming soon!) to unlock the next row of achievements",
